...
2. Build the helper command with the appropriate flags:
   ...
   node "$PLUGIN_ROOT/scripts/cc-codex-review.mjs" adversarial-review <FLAGS>
   ```
   Examples:
   - `node "$PLUGIN_ROOT/scripts/cc-codex-review.mjs" adversarial-review`
   - `node "$PLUGIN_ROOT/scripts/cc-codex-review.mjs" adversarial-review --base main`
   - `node "$PLUGIN_ROOT/scripts/cc-codex-review.mjs" adversarial-review --focus "challenge error handling"`
   - `node "$PLUGIN_ROOT/scripts/cc-codex-review.mjs" adversarial-review --path src/utils.js --focus "challenge the null checks"`
